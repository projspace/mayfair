...
if(!isset($attributes) || !is_array($attributes)) {
	$attributes = array();
	$attributes = array_merge($HTTP_POST_VARS, $HTTP_GET_VARS,$request); // GET overwrites POST
}
...
$Fusebox["layout"]=str_replace("src=\"","src=\"/shop",$Fusebox["layout"]);
$Fusebox["layout"]=str_replace("href=\"","href=\"/shop",$Fusebox["layout"]);
$Fusebox["layout"]=str_replace("action=\"","action=\"/shop",$Fusebox["layout"]);
