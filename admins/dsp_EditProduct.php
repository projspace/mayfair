	...
	<div id="tabs" class="form clearfix">
		...
		<div id="tabs-1">
			...
			<div class="form-field clearfix">
				...
				<input type="text" id="price" name="price" value="<?= number_format($product['price'], 2, ".", "") ?>" />
			</div>
			<!--<div class="form-field clearfix">
				<label for="price_old">Old Price ($)</label>
				<input type="text" id="price_old" name="price_old" value="<?= number_format($product['price_old'], 2, ".", "") ?>" />
			</div>
			<div class="form-field clearfix">
				<label for="discount">Discount ($)</label>
				<input type="text" id="discount" name="discount" value="<?= number_format($product['discount'], 2, ".", "") ?>" />
			</div>
			<div class="form-field clearfix">
			...
			<!--<div class="form-field clearfix">
				...
				<?
					...
					{
						echo "<label>&nbsp;</label><img src=\"{$config['dir']}images/product/medium/product_{$product['id']}.{$product['imagetype']}?time=".time()."\" /><br />";
						echo "
