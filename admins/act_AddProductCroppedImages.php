<?
	...
	if(count(array_unique($img_types)) > 1)
		$errors[] = 'All uploaded images must be of the same type: jpg, png or gif';
	...
	$ok=$db->CompleteTrans();
	if(!$ok)
		error("There was a problem whilst adding the images, please try again.  If this problem persists please contact your designated support contact","Database Error");
?>