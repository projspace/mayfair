...
/* <![CDATA[ */
	$(document).ready(function(){
		...
		$('#table_warnings .remove_row').click(function(){
			$(this).parent().parent().remove();
			return false;
		});
	});
...
/* <![CDATA[ */
	$(document).ready(function(){
		$('#vat').click(calculate_price);
		$('#price').keypress(calculate_price);
		$('#discount').keypress(calculate_price);
	});
...
<h1>Add Product</h1>
<form id="frmProduct" class="yui-skin-sam" method="post" <?= $wysiwyg->form(); ?> enctype="multipart/form-data" action="<?= $config['dir'] ?>index.php?fuseaction=admin.addProduct&amp;act=add">
	...
	<div id="tabs" class="form clearfix">
		...
		<div id="tabs-1">
			...
			<div class="form-field clearfix">
				...
				<span><input type="text" class="text" id="name" name="name" /></span>
			</div>
			<div class="form-field clearfix">
			...
			<!--<div class="form-field clearfix">
				...
				<input type="text" id="price_old" name="price_old" />
			</div>
			<div class="form-field clearfix">
			...
			<div class="form-field clearfix">
				...
				<input type="text" id="final_price" readonly="readonly" />
			</div>
			<div class="form-field clearfix">
			...
			<div class="form-field clearfix">
				...
				<input type="checkbox" id="no_shipping" name="no_shipping" value="1" />
			</div>
			<div class="form-field clearfix">
				<label>Stock</label>
			...
			<div class="form-field clearfix">
				...
				<input type="text" id="low_stock_trigger" name="low_stock_trigger" value="0" />
			</div>
			<div class="form-field clearfix">
				<label for="hide_stock_trigger">Hide Product on Stock Trigger</label>
				<input type="text" id="hide_stock_trigger" name="hide_stock_trigger" value="0" />
			</div>
			<div class="form-field clearfix">
			...
			<div class="form-field clearfix">
				...
				<input type="checkbox" id="buy_1_get_1_free" name="buy_1_get_1_free" value="1" />
			</div>
			<div class="form-field clearfix">
				<label for="recent_productions">From Recent Productions</label>
				<input type="checkbox" id="recent_productions" name="recent_productions" value="1" />
			</div>
			<div class="form-field clearfix">
				<label for="product_search">Product Search</label>
				<input type="checkbox" id="product_search" name="product_search" value="1" />
			</div>-->
			<div class="form-field clearfix">
				<label for="added">Date Added</label>
				<span><input type="text" class="calendar" id="added" name="added" value="<?=date('d/m/Y') ?>" /></span>
			</div>
			<!--<div class="form-field clearfix">
			...
			<div class="form-field clearfix">
				...
				<input type="checkbox" id="reviews" name="reviews" value="1" />
			</div>-->
			<div class="form-field clearfix">
				<label for="alt_size">Use alternating size</label>
				<input type="checkbox" id="alt_size" name="alt_size" value="1" />
			</div>
			<div class="form-field clearfix">
			...
			<!--<div class="form-field clearfix">
				...
				<input type="checkbox" id="vat_exempt" name="vat_exempt" value="1" />
			</div>-->
			<div class="form-field clearfix">
				<label for="flat_rate_shipping">Flat Rate Shipping</label>
				<input type="checkbox" id="flat_rate_shipping" name="flat_rate_shipping" value="1" />
			</div>
            <div class="form-field clearfix">
				<label for="hide_quick_view">Hide Quick View</label>
				<input type="checkbox" id="hide_quick_view" name="hide_quick_view" value="1"/>
			</div>
            <div class="form-field clearfix">
				<label for="hide_add_cart">Hide Add to Cart</label>
				<input type="checkbox" id="hide_add_cart" name="hide_add_cart" value="1"/>
			</div>
            <div class="form-field clearfix">
				<label for="hide_more_details">Hide More Details</label>
				<input type="checkbox" id="hide_more_details" name="hide_more_details" value="1"/>
			</div>
            <div class="form-field clearfix">
				<label for="hide_price">Hide Price</label>
				<input type="checkbox" id="hide_price" name="hide_price" value="1"/>
			</div>
            <div class="form-field clearfix">
				<label for="featured">Featured</label>
				<select id="featured" name="featured">
                <? for($i=0;$i<=4;$i++): ?>
					<option value="<?= $i ?>"><?=$i?:'No'?></option>
				<? endfor; ?>
				</select>
			</div>
			<div class="form-field clearfix">
				...
				<select id="zoom" name="zoom">
					...
					<!--<option value="portrait">Yes + Portrait image for clothing</option>-->
				</select>
			</div>
            <div class="form-field clearfix">
				<label for="warehouse">Warehouse</label>
				<select id="warehouse" name="warehouse">
					<option value="mayfair_house">Mayfairhouse</option>
					<option value="fulfillment_house">Fulfillment House</option>
		...
		<div id="tabs-2">
			...
			<table class="values nocheck" id="table_options">
				<tr>
					<th class="sortable first"><a href="#" title="Sort on UPC Code" class="sort">UPC Code</a></th>
					...
					<th class="sortable last"><a href="#" title="Sort on Quantity" class="sort">Quantity</a></th>
					<th>&nbsp;</th>
				</tr>
			</table>
		</div>
		...
		<div id="tabs-6">
			<div class="form-field clearfix">
				...
				<input type="text" id="meta_title" name="meta_title" /><br />
			</div>
			<div class="form-field clearfix">
				<label for="meta_description">META Description</label>
				<textarea id="meta_description" name="meta_description" rows="3" cols="40"></textarea><br />
			</div>
			<div class="form-field clearfix">
				<label for="meta_keywords">META Keywords</label>
				<textarea id="meta_keywords" name="meta_keywords" rows="3" cols="40"></textarea><br />
			</div>
		</div>
		/<!--<div id="tabs-7">
			<script language="javascript" type="text/javascript">
					...
					<?
						for($j=1;$j<=$fitting_count['column_count'];$j++)
						{
							if($category_fitting_guide_columns[$fitting_guides_columns[$j]['column_id']])
								...
								$checked = '<input type="checkbox" class="column" name="column_ids[]" value="'.$fitting_guides_columns[$j]['column_id'].'"/>';
		...
		<div id="tabs-9">
			...
			<div class="form-field clearfix">
				...
				<input type="checkbox" id="360_view" name="360_view" value="1" />
			</div>
			<div class="form-field clearfix">
			...
			<div class="form-field clearfix">
				...
				<input type="checkbox" id="twitter" name="google" value="1" checked="checked" />
			</div>
			<div class="form-field clearfix">
				<label for="pinterest">Pinterest Link</label>
				<input type="checkbox" id="twitter" name="pinterest" value="1" checked="checked" />
			</div>
			<div class="form-field clearfix">
