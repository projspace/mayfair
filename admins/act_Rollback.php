<?
	...
	include("qry_ApproveRollback.php");
    ...
    if($ok)
    {
		...
		error("There was a problem whilst performing the rollback, please try again.  If this persists please notify your designated support contact","Database Error");
?>