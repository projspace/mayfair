...
<form method="post" action="<?= $config['dir'] ?>index.php?fuseaction=admin.addACLGroup&amp;act=add">
			...
			<?
				...
				while($row=$actions->FetchRow())
				{
					...
					if($class=="dark")
						...
						$class="dark";
					echo "<tr>
							<td class=\"{$class} thin\"><input type=\"checkbox\" id=\"acl_action_{$row['id']}\" name=\"acl_action[]\" value=\"{$row['id']}\"/></td>
