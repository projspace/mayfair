...
<input type="text" id="custom_kelkoo_" name="kelkoo[field_e]" value="<?= $custom["kelkoo_field_e"] ?>" /><br />

<label for="custom_kelkoo_"></label>
<input type="text" id="custom_kelkoo_" name="kelkoo[field_f]" value="<?= $custom["kelkoo_field_f"] ?>" /><br />
