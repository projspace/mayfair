...
<h1>Add Content</h1>
<form method="post" id="frmValidate" action="<?= $config['dir'] ?>index.php?fuseaction=admin.addContentArea&act=add">
	<div id="tabs" class="form clearfix">
		...
		<div id="tabs-1">
			<div class="form-field clearfix">
				...
				<span><input type="text" id="name" class="text" name="name" value="<?=$_POST['name'] ?>" /></span>
			</div>
		</div>
		<div id="tabs-2">
