...
<form method="post" id="frmValidate" action="<?= $config['dir'] ?>index.php?fuseaction=admin.addEmail&amp;act=save">
	<div id="tabs" class="form clearfix">
		...
		<div id="tabs-1">
			<div class="form-field clearfix">
				...
				<span><input type="text" class="text" id="name" name="name" value="" /></span>
			</div>
			<div class="form-field clearfix">
				<label for="to">To</label>
				<input type="text" class="text" id="to" name="to" />
			</div>
			<div class="form-field clearfix">
				<label for="cc">Cc</label>
				<input type="text" class="text" id="cc" name="cc" />
			</div>
			<div class="form-field clearfix">
				<label for="bcc">Bcc</label>
				<input type="text" class="text" id="bcc" name="bcc" />
			</div>
		</div>
		<div id="tabs-2">
			<div class="form-field clearfix">
				<label for="subject">Subject</label>
				<span><input type="text" class="text" id="subject" name="subject" /></span>
			</div>
