...
<h1 class="pageTitle">
	<a class="button button-grey button-slide" title="Print" href="<?=$config['dir'] ?>index.php?fuseaction=admin.orders&act=print" target="_blank"><span>Print</span></a>
	<a class="button button-grey button-slide" title="Export" href="<?=$config['dir'] ?>index.php?fuseaction=admin.orders&act=export"><span>Export Orders</span></a>
	Orders
</h1>
...
<?
	...
	if($nr_pages > 1)
	{
		...
		echo '<div style="width:100%;" class="paginator"><ul>';
			...
			$results_page = array();
			$results_page[] = 'fuseaction=admin.orders';
