...
*/
	...
	function setMagicQuotes($mq)
	{
		$this->_magic_quotes=$mq;
	}
	...
	*/
	function Quote($s)
	{
		return $this->qstr($s,$this->_magic_quotes);
	}
	
	/**
	* Handle quoting for non insertion variables
	*/
	function QuoteName($s)
	{
		$ret=$this->qstr($s,$this->_magic_quotes);
		//return substr($ret,1,strlen($ret)-2);
		return ereg_replace("[^A-Za-z]","",$ret);
	}
...
*/
  ...
  /**
	 * Get the keys as an associative array
	 */
	function GetKeys()
	{
		$nfields=$this->FieldCount();
		for($i=0;$i<$nfields;$i++)
		{
			$obj=$this->FetchField($i);
			$keys[$obj->name]=$i;
			$keys[$obj->table.".".$obj->name]=$i;
		}
		return $keys;
	}
	/**
	 * Get the keys as an associative array for smarty
	 */
	function GetKeysSmarty()
	{
		$nfields=$this->FieldCount();
		for($i=0;$i<$nfields;$i++)
		{
