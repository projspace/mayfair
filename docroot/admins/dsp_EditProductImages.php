...
<h1>Edit Product Images</h1>
	...
	<div id="tabs" class="form clearfix">
		<ul>
			...
			<li><a href="#tabs-3">360&deg; Images</a></li>
			<!--<li><a href="#tabs-4">Upload 360&deg; Images</a></li>-->
				...
				else
				{
					while($row=$images->FetchRow())
					{
						echo "<div class=\"form-field clearfix\">
								...
								<a style=\"margin-right: 10px;\" class=\"button button-grey\" href=\"{$config['dir']}index.php?fuseaction=admin.editProduct&amp;act=reuploadImage&amp;image_id={$row['id']}&amp;product_id={$_REQUEST['product_id']}&amp;category_id={$_REQUEST['category_id']}\"><span style=\"width: auto;\">Re-upload</span></a>
		...
		<div id="tabs-2">
			<form id="frmImages" method="post" enctype="multipart/form-data" action="<?= $config['dir'] ?>index.php?fuseaction=admin.editProduct&act=addImage">
		...
		<div id="tabs-6">
			<form id="frmImages" method="post" enctype="multipart/form-data" action="<?= $config['dir'] ?>index.php?fuseaction=admin.editProduct&act=addCroppedImages">
				<input type="hidden" name="category_id" value="<?=$_REQUEST['category_id'] ?>"/>
				<input type="hidden" name="product_id" value="<?=$_REQUEST['product_id'] ?>"/>
