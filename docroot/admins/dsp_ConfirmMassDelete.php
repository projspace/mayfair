...
?>
<h1>Are you sure?</h1>
<p>You are about to perform a mass deletion of one of more products, displayed below.  Please note that this is a permanent action and cannot be undone.  Please double check the list to ensure any products you do not wish to remove are unchecked.  Once you are sure, please click on the "Confirm" button below.</p>
<br />
<form method="post" action="<?= $config['dir'] ?>index.php?fuseaction=admin.massDelete&act=confirm">
