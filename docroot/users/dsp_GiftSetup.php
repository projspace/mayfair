        ...
        <form method="post" action="" id="frm">
            ...
            <div class="tab-wrapper" id="tabbing">
                ...
                <div class="tab-content">
                    <h3 class=" capital clear">Please provide us with your contact details</h3>
                    <div class=" detail-section block-full">
                        ...
                        <div class="clear"></div>
                        <div class="block">
                            <label>PHONE*:<br /><em style="font-size: 14px; text-transform: none !important;">123-456-7890</em></label>
                ...
                <div class="tab-content" >
                    ...
                    <div class=" detail-section block-full">
                        ...
                        <div class="block multi first caps-all">
                            <label>password*:<br /><em style="font-size: 14px; text-transform: none !important;">Please create a password to manage and edit your gift registry</em></label>
...
/* <![CDATA[ */
    ...
    fields[fields.length] = {'id':'address4', 'name':"City", 'type':'required', 'step': 3};
	fields[fields.length] = {'id':'postcode', 'name':"Zip code", 'type':'required|postcode', 'step': 3};
	...
	$(document).ready(function(){
        ...
        $('#address1, #postcode, #area_id, #country_id').keyup(validateInput).change(validateInput);
