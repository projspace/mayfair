...
<div class="banner">
    ...
    <ul class="right-banner">
        <li class="free-shipping"><img src="<?= $config['layout_dir'] ?>images/freeshipping.jpg" alt="free shipping" title="free shipping" /></li>
        <li><img src="/images/gucci.jpg"  alt="multiberry" /></li>
        <li class="sign-up">
            <h2>KEEP IN TOUCH</h2>
            <p>Exclusive offers when you subscribe to our newsletter</p>
            <iframe src="<?=$config['dir'] ?>homefs" width="204" height="110" style="margin-top: 15px; overflow: hidden;"></iframe>
            <!--
            <ul>
