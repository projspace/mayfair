<span class="siteTitle">User Registration</span><br><br>
...
<p><b>Once you have completed this form you will be taken back to your Shopping Cart to complete checkout</b></p>
<center>
{if $reason neq ""}
	<b>Error:</b> {$reason}
{/if}
<table border="0">
	<form method="post" action="{$config.dir}index.php/fuseaction/user.registerCheckout/act/register">
	{if $return neq ""}
