...
<? endif; ?>
	...
	<form method="post" action="<?=$config['dir'] ?>account/addAddress?act=save<? if(isset($_REQUEST['ajax'])): ?>&amp;ajax=1<? endif; ?>" style="padding: 30px 35px 70px;" class="std-form inner" id="frm" style="width: auto;">
		<?=$validator->displayMessage() ?>
		<fieldset>
			<div class="row">
				<label for="name">Name *</label>
				<input type="text" class="text" value="<?=$_REQUEST['name'] ?>" name="name" id="name" />
			</div>
			<div class="row">
				<label for="email">Email *</label>
				<input type="text" class="text" value="<?=$_REQUEST['email'] ?>" name="email" id="email" />
			</div>
			<div class="row">
			...
			<div class="row">
				...
				<input type="text" class="text" value="<?=$_REQUEST['line1'] ?>" name="line1" id="line1" />
			</div>
			<div class="row">
				<label for="line2">Line 2</label>
				<input type="text" class="text" value="<?=$_REQUEST['line2'] ?>" name="line2" id="line2" />
			</div>
			-->
			<div class="row">
			...
			<div class="row">
				...
				<input type="text" class="text" value="<?=$_REQUEST['line3'] ?>" name="line3" id="line3" />
			</div>
			<div class="row">
				<label for="line4">County</label>
				<input type="text" class="text" value="<?=$_REQUEST['line4'] ?>" name="line4" id="line4" />
			</div>
			<div class="row">
				<label for="postcode">Postcode *</label>
				<input type="text" class="text" value="<?=$_REQUEST['postcode'] ?>" name="postcode" id="postcode" />
			</div>
			<div class="row">
				<label for="billing">Billing</label>
				<input type="checkbox" value="1" name="billing" id="billing" <?=($_REQUEST['billing']+0)?'checked="checked"':'' ?> />
			</div>
			<div class="row">
				<label for="delivery">Delivery</label>
				<input type="checkbox" value="1" name="delivery" id="delivery" <?=($_REQUEST['delivery']+0)?'checked="checked"':'' ?> />
			</div>
		</fieldset>
		<div class="submit"><a href="#" class="btn-red submit">Add</a></div>
	</form>
